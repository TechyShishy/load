...
export class FiveGActivationCard extends EventCard {
  ...
  override readonly flavorText = 'Not your fault. Not your call. Still your problem.';
  ...
  // TODO-0011 (#35): add a Negotiate Contract action card (MitigateEvent subtype targeting event-5g-activation)
