...
export function ContinueModal({ onContinue, onNewGame }: ContinueModalProps) {
  ...
  return (
    <FocusTrap focusTrapOptions={{ initialFocus: '#continue-modal-continue-btn' }}>
      <div
      ...
      >
        <div className="border border-cyan-700 bg-gray-950 rounded-lg p-8 max-w-sm w-full text-center shadow-2xl">
          <h2 id="continue-modal-title" className="sr-only">Resume game?</h2>
          ...
          <div className="flex gap-4 justify-center">
            <button
              id="continue-modal-continue-btn"
              onClick={onContinue}
